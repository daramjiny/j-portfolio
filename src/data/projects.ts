...
export const projects: Project[] = [
    ...
    },
    {
        ...
        title: "Eucerin bidding page",
        description: "유세린 프로모션 비딩페이지로 제품명을 이용한 이벤트 랜딩페이지를 디자인했습니다. 유세린 내 디자인 가이드에 맞춰서 작업하되 너무 딱딱한 느낌이 들지 않도록 상품 및 일러스트를 배치하여 작업했습니다.",
        fullDescription: "유세린 프로모션 비딩페이지로 제품명을 이용한 이벤트 랜딩페이지를 디자인했습니다. 유세린 내 디자인 가이드에 맞춰서 작업하되 너무 딱딱한 느낌이 들지 않도록 상품 및 일러스트를 배치하여 작업했습니다.",
        tags: ["Landing Page", "Web Design", "Promotion"],
        year: "2016",
        category: "PAGE",
    ...
    },
    {
        ...
        title: "OLIVE YOUNG Promotion(습작)",
        description: "올리브영 썸머시즌 세일상품을 임의로 선택하여 최대 50% 할인이벤트 내용으로 제작했습니다. 블루와 퍼플색상을 활용하여 은은하면서도 시원한 느낌이 나도록 디자인했습니다.",
        fullDescription: "올리브영 썸머시즌 세일상품을 임의로 선택하여 최대 50% 할인이벤트 내용으로 제작했습니다. 블루와 퍼플색상을 활용하여 은은하면서도 시원한 느낌이 나도록 디자인했습니다.",
        tags: ["Landing Page", "Web Design", "Promotion"],
        year: "2025",
        category: "PAGE",
    ...
    {
        id: "emart-mall-face",
        title: "emartmall Facebook Feed",
        description: "오전/오후로 진행하는 이마트몰 이벤트 내용을 단일 이미지 및 슬라이드 이미지로 작업하였습니다.",
    ...
    {
        id: "emart-mall-insta",
        title: "emartmall Instargram Feed",
        description: "오전/오후로 진행하는 이마트몰 이벤트 내용을 단일 이미지 및 슬라이드 이미지로 작업하였습니다.",
    ...
    {
        id: "siwon-school-pro",
        title: "siwonschool event page",
        description: "시원스쿨 내 할인상품 프로모션 페이지로 브랜드 색상을 주조색으로 가격과 할인율을 강조하면서도 심플하게 배치해서 정보를 한눈에 들어올 수 있도록 디자인했습니다.",
        fullDescription: "시원스쿨 내 할인상품 프로모션 페이지로 브랜드 색상을 주조색으로 가격과 할인율을 강조하면서도 심플하게 배치해서 정보를 한눈에 들어올 수 있도록 디자인했습니다.",
        tags: ["Landing Page", "Web Design", "Promotion"],
        year: "2017",
        category: "PAGE",
